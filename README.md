...
Two JSON files will be provided by the university, containing a [train set](train.json) and a [test set](test.json). Evaluation of our predictions on the unlabeled test set, will be done through applying this code:
